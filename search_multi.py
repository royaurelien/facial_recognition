...
calc_method = 'convert' # poly, percent
...
if __name__ == '__main__':
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        ...
        futures = {executor.submit(tools.multi_process_file, part, options):part for part in parts}
    ...
    for filename in files:
        image_array, image_hash, face_locations = tools.process_file(filename, upsample=DEFAULT_UPSAMPLE)
        known_file = True if image_hash in known_files else False
